    ...
    <div className="w-full h-screen bg-zinc-900 p-20 flex gap-5">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="font-bold text-8xl uppercase leading-none tracking-tight">
            Eye-
          </h1>
          <h1 className="font-bold text-8xl uppercase leading-none tracking-tight">
            Opening
      ...
      <div className="w-1/2 h-full">
        <h1 className="font-bold text-7xl uppercase leading-none tracking-tight">
          Presentations
        </h1>
        ...
        <p className="mt-10">
          ...
          sapien in velit sollicitudin consectetur. Pellentesque habitant morbi
          tristique senectus et netus et malesuada fames ac turpis egestas.
          Vivamus eu lectus id nisi gravida pharetra. Nunc quis felis at urna
          ultrices placerat. Mauris in libero nec sapien dictum tincidunt. Sed
          sollicitudin quam quis justo ultrices, ut fermentum orci commodo.
          Quisque euismod lacus non velit luctus, eget efficitur odio eleifend.
          Cras ac odio mauris. Quisque nec ex a dui accumsan tempus. Nullam
          euismod, risus id dapibus luctus, diam dui fermentum orci, vel varius
          risus ex non eros. Vivamus eget enim euismod, interdum tortor non,
          suscipit arcu. Donec nec enim non lorem hendrerit ullamcorper.
          Phasellus ultricies fringilla massa sit amet molestie. Vivamus mattis
          felis at est bibendum, in tristique justo posuere. Sed aliquet
          vestibulum sapien, eu fermentum nisl volutpat nec.
        </p>
      </div>
    </div>
  );
